                    ...
                    <form method="post" data-parsley-validate>
                        ...
                        <div class="m-2 p-3 bg-primary  bg-opacity-10 border border-info  rounded">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" name="title" value="<?php echo $article->title ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Author</label>
                                <input type="text" class="form-control form-control-sm" name="author" rows="5" value="<?php echo $article->author ?>" required>
                            </div>
